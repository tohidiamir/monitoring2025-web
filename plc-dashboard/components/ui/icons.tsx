...
export const Beaker: React.FC<IconProps> = ({ className = '' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v4m6-4v4M9 7h6l3 9a2 2 0 01-2 2H8a2 2 0 01-2-2l3-9z" />
